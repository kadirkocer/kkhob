...
export function EntryModal({ entryId, open, onOpenChange }: EntryModalProps) {
  ...
  const handleEdit = () => {
    window.open(`/entries/${entryId}`, '_blank')
  }
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        {isLoading ? (
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                {!entry.description && !entry.content_markdown && (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">This entry doesn't have any content yet.</p>
                    <Button variant="outline" size="sm" onClick={handleEdit}>
                      <Edit3 className="h-4 w-4 mr-2" />
                      Add Content
                    </Button>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">The entry you're looking for doesn't exist.</p>
          </div>
        )}
      </DialogContent>
    </Dialog>
